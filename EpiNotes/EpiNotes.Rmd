...
```{r contingency-dh01, echo=FALSE, message=FALSE}
contingencydh <- tibble(" " = c("Outcome", "No outcome", ""),
            "Exposed" = c("d1", "h1", "1"),
            "Unexposed" = c("d0", "h0", "0"),
            "total" = c("d", "h", "n")
            )
knitr::kable(contingency, booktabs = TRUE, caption= "Contingency table. This table is the same, but contains the d/h and 0/1 notation used later in some of the equations.", escape=FALSE)
```
