...
- _NumPy_  is necessary to use any sums.  It introduces arrays which MAKE PYTHON WORK LIKE R: elementwise mathematical operations; it's a little tidyverselike because you can use proximal assignments to make distal ones.  Does this mean lazy evaluation? Arrays can contain any typep but all the same type. 
