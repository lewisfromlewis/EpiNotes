...
knitr::kable(rel_risk, booktabs = TRUE, caption= "Initially", align = 'c', padding = 2, escape=FALSE)
...
knitr::kable(rel_risk_clockwise, booktabs = TRUE, caption= "Clockwise", align = 'c', padding = 2, escape=FALSE)
```
...
knitr::kable(rel_risk_right, booktabs = TRUE, caption= "Right-shifted", align = 'c', padding = 2, escape=FALSE)
```
