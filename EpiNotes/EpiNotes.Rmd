...
knitr::kable(rel_risk, booktabs = TRUE, caption= "Instability of relative risk", align = 'c', padding = 2, escape=FALSE)
...
If the RR doubles to 6 by "clockwise rotation" of the table, as shown below, then the OR is not doubled but instead rises to 18.857
...
knitr::kable(rel_risk_clockwise, booktabs = TRUE, caption= "Clockwise table", align = 'c', padding = 2, escape=FALSE)
...
The Poisson distribution has both mean and variance equal to λ, which is events over a given time, $\lambda = \frac{D}{t}$
