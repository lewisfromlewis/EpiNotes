...
- Frequency matching creates groups who are exposed, or unexposed, and who are the same in the frequency of whatever matching variables is desired. Group parameters are calculated and pooled

- Individual matching takes cases and only selects controls who possess the same value of the matching characteristic. Matched analysis is needed 
