...
If the matched variable is on the causal pathway it causes a bias, which will generally by to underestimate the effect of exposure on outcome. 
...
Vaccine efficacy is foolish, "usually" 1-(Risk in vaccinated/Risk in Unvaccinated).
	...
	and if a 2nd stage cluster, infection probability beta, VEs =0, proportion infected at time t It, contact probability c, duration of contact d then in population of n individuals the hazard rate for infection if vaccinated is $\lambda_{0i}(t) = {c \beta I_{i}t}{n_i}$ and for unvaccinated is that times 1-VEi. 
