...
There are other definitions and literal reams devoted to identifying confounders, which have much more nuanced definitions and exacting analytic approaches. 

The four elemental means of confounding could be The Fork:
...
Centreing, eg $\mu_i = \alpha + \beta(X_i - \bar{X})$, makes it easier to define a scientifically meaningful prior. 
